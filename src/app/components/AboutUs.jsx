...
const AboutUs = () => {
    ...
    // Generate array [1, 2, ..., 10]
    const numbers = Array.from({ length: 10 }, (_, i) => i + 1);

    return (
        <div
            ref={containerRef}
            className='py-16 md:py-[100px] flex flex-col justify-center items-center w-full max-w-[1380px] mx-auto px-4 md:px-8'
        >
            ...
            >
                <span className='inline-block mr-1 md:mr-2'>We blend strategy,</span>
                <span className='inline-block mr-1 md:mr-2'>creativity & technology</span>
                <span className='inline-block mr-1 md:mr-2'>to deliver</span>
                <span className='inline-block underline decoration-2 md:decoration-3 underline-offset-4 md:underline-offset-8 mr-1 md:mr-2'>measurable results</span>
                <span className='inline-block mr-1 md:mr-2'>- because every pixel,</span>
                <span className='inline-block mr-1 md:mr-2'>every click, and</span>
                <span className='inline-block mr-1 md:mr-2'>every campaign should</span>
                <span className='inline-block underline decoration-2 md:decoration-3 underline-offset-4 md:underline-offset-8'>move your business forward!</span>
            </h1>

            {/* CTA REF CONTAINER (Grid + Button) */}
            <div
                ref={ctaRef}
                className='mt-10 md:mt-16 w-full flex flex-col items-center'
            >
                {/* Grid */}
