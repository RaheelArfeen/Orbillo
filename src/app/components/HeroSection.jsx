        ...
        <div className="h-screen relative overflow-hidden flex items-center justify-center">
            ...
            <section className='z-20 text-center pt-30 mb-20 px-4'>
                ...
                <h1 className='lg:text-6xl md:text-5xl min-[400px]:text-3xl text-2xl max-[350px]:text-xl 2 max-[350px]:p-0 capitalize leading-[130%] md:max-w-[850px] max-w-[450px] recoleta'>
                    We help businesses grow with strategy-Driven designs & development
                </h1>
            ...
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full flex items-center justify-center z-10">
                <Image
                    src={ItemsImageSvg}
                    alt="Items"
                    className="min-w-[1000px] lg:max-w-[90%] h-auto block lg:hidden"
                    priority
                />
                ...
                <Image
                    src={ItemsImagePng}
                    alt="Items"
                    className="w-full lg:max-w-[90%] h-auto hidden lg:block"
                    priority
                />
            </div>
        </div>
