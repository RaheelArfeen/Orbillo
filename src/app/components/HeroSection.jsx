...
import background from '../assets/HeroBackground.svg';
...
const HeroSection = () => {
    return (
        <div className="h-screen relative overflow-hidden flex items-center justify-center">
            <div className='absolute inset-0 z-10 bg-linear-to-b from-transparent to-[#11180B]/35'></div>
            <div>
                <Image
                    src={background}
                    alt="Background"
            ...
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full flex items-center justify-center">
                <Image
                    src={ItemsImage}
                    alt="Items"
