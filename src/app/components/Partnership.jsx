    ...
    return (
        <section className='w-full bg-white'>
            <div className='max-w-[1380px] mx-auto py-20 px-4 flex flex-col items-center justify-center'>
                <h1 className="text-[36px] sm:text-[48px] md:text-[50px] font-semibold text-[#212121] bricolage max-w-[700px] leading-[1] text-center tracking-tight">
                    Performance-Driven Design, Built as a {''}
                    <span className="playfair italic text-4xl sm:text-4xl md:text-[52px]">Partnership</span>
                </h1>
