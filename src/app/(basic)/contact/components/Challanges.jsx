...
const Challanges = () => {
    return (
        <div>
            <section className='max-w-[1320px] mx-auto px-4 flex flex-col md:flex-row items-center gap-8 py-25 space-y-10'>
                <div>
                    <h1 className='text-[#373737] text-3xl md:text-4xl reloceta leading-[140%] -tracking-[1px] max-w-[650px] mb-9'>At Orbillo, we believe that every business challenge can be solved through the right design approach..</h1>
