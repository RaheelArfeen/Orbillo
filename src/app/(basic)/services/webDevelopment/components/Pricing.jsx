...
const pricingCards = [
    {
        id: 1,
        title: 'Essential',
        description: 'Perfect for small businesses and personal brands needing a clean web presence.',
        price: '699.00',
        features: [
            'Up To 5 Pages',
    ...
    },
    {
        id: 2,
        title: 'Professional',
        description: 'Perfect for growing businesses ready to scale their online presence.',
        price: '1799.00',
        features: [
            'Up To 12 Pages',
    ...
    },
    {
        id: 3,
        title: 'Enterprise',
        description: 'Perfect for businesses that need a fully custom, high-performance web solution.',
        price: '4499.00',
        features: [
            'Up To 25 Pages',
            'Full Custom Design & Development',
            'Advanced SEO & Analytics Setup',
            'E-Commerce Or Web App Integration',
