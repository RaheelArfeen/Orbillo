    ...
    return (
        <div className="h-screen relative overflow-hidden flex items-center justify-center">
            ...
            <section className='z-20 text-center pt-30 mb-40 px-4'>
                <p className='outfit uppercase text-[#C7C7C7] font-bold text-sm md:text-lg mb-3 tracking-[2.7px]'>Branding & identity</p>
                <h1 className='lg:text-6xl md:text-5xl min-[400px]:text-3xl text-2xl max-[350px]:text-xl 2 max-[350px]:p-0 capitalize leading-[130%] md:max-w-[950px] max-w-[450px] recoleta'>
                    <span>We design</span> {' '}
                    <span>
                        <span className='text-[#C9FF90] underline decoration-[#C9FF90] decoration-3 underline-offset-5'>logos & brand systems</span> {' '}
                    </span>
            ...
            <section className='z-50 absolute bottom-0 max-w-[900px] min-w-[800px] flex gap-2 md:gap-4 items-end justify-center'>
                <img src={'https://i.ibb.co.com/jYWrByq/image.png'} />
            </section>
