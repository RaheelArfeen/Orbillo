    ...
    return (
        <div className="relative overflow-hidden flex items-center justify-center">
            ...
            <section className='z-20 text-center pt-30 mb-40 px-4'>
                ...
                <h1 className="text-[36px] sm:text-[48px] md:text-[50px] font-semibold text-[#C9FF90] bricolage leading-[1.1] md:leading-[60px] mb-4 tracking-tight">Branding Identity</h1>
