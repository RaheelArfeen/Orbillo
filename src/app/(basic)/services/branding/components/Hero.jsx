        ...
        <div className="relative overflow-hidden flex items-center justify-center">
            ...
            <section className='z-20 text-center pt-30 mb-[75px] px-4 flex flex-col items-center justify-center'>
                ...
                <h1 className="bricolage text-3xl md:text-5xl text-white font-medium tracking-tighter leading-[120%] mb-4 ">
                    ...
                    <span>
                        <span className="playfair font-semibold"> Remembered</span> - We Make It Happen
                    </span>
                </h1>
                <p className='outift text-lg text-white/79 tracking-wide leading-[146%] max-w-[620px] mb-8'>Bold identities, timeless visuals and branding that builds trust, stands out and grows with your business.</p>
