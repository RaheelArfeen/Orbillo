...
const Tag = memo(({ text }) => (
    <div className="ml-[15px] shrink-0 bg-[#02403A] border border-[#C9FF90]/20 rounded-full hover:border-white hover:bg-white hover:text-[#07302C] text-[#C9FF90] transition-colors duration-300 group cursor-pointer">
        <div className="px-6 py-4 text-sm sm:text-base md:text-lg whitespace-nowrap outfit">
            {text}
        </div>
    </div>
));
...
const OurWorkMarque = () => {
    ...
    return (
        <div className='relative overflow-hidden bg-[#02403A]'>
            ...
            <section className='mx-auto py-12 md:py-30'>
                <div className='max-w-[1380px] mx-auto px-5 md:px-10 mb-20'>
