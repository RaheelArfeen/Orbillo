    ...
    const cards = [
        {
            ...
            description: "Eye-catching, on-brand post designs crafted for Facebook, Instagram, LinkedIn and X that stop the scroll and spark engagement.",
            src: ProductDesign,
        },
        {
            title: "Story & Reel Cover Design ",
            description: "Bold, branded story and reel covers that keep your profile looking polished, professional and visually consistent.",
            src: MobileUX,
        },
        {
            title: "Social Media Branding Kit ",
            description: "Complete social media brand kits including profile pictures, covers, highlight icons and templates built for consistency across every platform.",
            src: Redesign
        },
        {
            title: "Content Template Design ",
            description: "Reusable, editable design templates that let your team post on-brand content quickly without starting from scratch every time.",
            src: Prototype
        },
    ];
        ...
        <div>
            <section className='py-12 md:py-25 px-5 2xl:px-0'>
                ...
                <section className='flex flex-col items-center'>
                    <h1 className='text-[32px] text-[#212121]/90 tracking-tight max-w-[750px] text-center bricolage'>We're a team of passionate social media designers who believe great content is more than pretty graphics. We research, strategize and craft visual content that feels native, drives engagement and delivers real business growth.</h1>
                        ...
                        <div className='flex flex-col lg:flex-row items-end justify-between gap-8 mb-20'>
                            <div className='space-y-8 lg:text-left text-center w-full flex flex-col items-center lg:items-start'>
                                ...
                                <h3 className='text-3xl md:text-5xl max-w-[660px] font-semibold bricolage capitalize text-[#212121] tracking-tight leading-[122%]'>
                                    <p>Everything for a Consistent, <span className='playfair'>High-Performing</span> Social</p>
                                </h3>
                            </div>
                            <div>
                                <p className='outfit text-xl text-[#4B4B4B] max-w-[600px] text-center lg:text-left'>
                                    At Orbillo, we turn your brand into thumb-stopping content that connects, converts and keeps your audience coming back.
                                </p>
                            </div>
                        </div>
