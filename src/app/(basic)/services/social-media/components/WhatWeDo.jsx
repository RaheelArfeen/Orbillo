        ...
        <div>
            <section className='py-12 md:py-25 px-5 2xl:px-0'>
                ...
                <section className='flex flex-col items-center'>
                    <h1 className='text-[32px] text-[#212121]/90 tracking-tight max-w-[750px] text-center'>We're a team of passionate social media designers who believe great content is more than pretty graphics. We research, strategize and craft visual content that feels native, drives engagement and delivers real business growth.</h1>
