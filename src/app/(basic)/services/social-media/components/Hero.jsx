...
const Hero = () => {
    return (
        <div className="h-screen relative overflow-hidden flex items-center justify-center">
            ...
            <section className='z-50 absolute bottom-0 min-w-[800px] flex gap-2 md:gap-4 items-end justify-center scale-110'>
                <img src='https://i.ibb.co.com/4Rvb8GtB/image.png' />
            </section>
