...
const CARD_CONTENT = [
    {
        ...
        content: 'We dig into your brand, audience and competitors to build a content visual strategy that actually works.',
        bgColor: 'bg-[#E5FFCA]'
    },
    {
        id: '02',
        title: 'Content Direction & Moodboard',
        content: 'We define the visual tone, style and content direction before a single design is made.',
        bgColor: 'bg-[#FFCFEA]'
    },
    {
        id: '03',
        title: 'Design & Revisions',
        content: 'We craft your social media visuals, refined, on-brand and optimized for each platform’s format and audience.',
        bgColor: 'bg-[#FAE4B6]'
    },
    {
        id: '04',
        title: 'Handoff & Content Support',
        content: 'Clean delivery of all design files, templates and assets with full support until your content is live and performing.',
        bgColor: 'bg-[#E5C6FE]'
    },
]
