    ...
    return (
        <div className="relative overflow-hidden flex items-center justify-center">
            ...
            <section className='z-20 text-center py-30 pt-50 mb-20 px-4 flex flex-col items-center justify-center gap-4'>
                <p className='outfit uppercase text-[#EAEAEA] font-bold text-sm md:text-base tracking-[2.7px]'>About Us</p>
                <h1 className="text-[32px] sm:text-[40px] md:text-[50px] font-semibold text-[#FFFFFF] bricolage max-w-[700px] leading-[1.2] md:leading-[60px] tracking-tight">
                    Design That Grows Business
                </h1>
