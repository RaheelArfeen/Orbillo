    ...
    },
    {
        ...
        icon: (
            <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg" className='size-10 md:size-12'>
                <path d="M27.533 16.0611C30.701 16.0611 33.2691 13.4929 33.2691 10.325C33.2691 7.15701 30.701 4.58887 27.533 4.58887C24.365 4.58887 21.7969 7.15701 21.7969 10.325C21.7969 13.4929 24.365 16.0611 27.533 16.0611Z" stroke="#07302C" stroke-width="2.26301" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M23.4024 14.4541L14.4541 23.4024" stroke="#07302C" stroke-width="2.26301" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M10.325 33.2701C13.4929 33.2701 16.0611 30.7019 16.0611 27.534C16.0611 24.366 13.4929 21.7979 10.325 21.7979C7.15701 21.7979 4.58887 24.366 4.58887 27.534C4.58887 30.7019 7.15701 33.2701 10.325 33.2701Z" stroke="#07302C" stroke-width="2.26301" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M16.0615 27.5332H39.006" stroke="#07302C" stroke-width="2.26301" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M44.741 33.2701C47.909 33.2701 50.4771 30.7019 50.4771 27.534C50.4771 24.366 47.909 21.7979 44.741 21.7979C41.573 21.7979 39.0049 24.366 39.0049 27.534C39.0049 30.7019 41.573 33.2701 44.741 33.2701Z" stroke="#07302C" stroke-width="2.26301" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M31.6628 40.6114L40.6112 31.6631" stroke="#07302C" stroke-width="2.26301" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M27.533 50.4781C30.701 50.4781 33.2691 47.9099 33.2691 44.742C33.2691 41.574 30.701 39.0059 27.533 39.0059C24.365 39.0059 21.7969 41.574 21.7969 44.742C21.7969 47.9099 24.365 50.4781 27.533 50.4781Z" stroke="#07302C" stroke-width="2.26301" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
        )
    },
    {
                ...
                <div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col justify-center items-center">
                    ...
                    <div className='max-w-[1380px] w-full mx-auto px-6 md:px-4'>
                        ...
                        <div className='w-full flex items-center justify-center mt-20'>
                            <button className='bg-[#C9FF90] outfit font-medium text-xl text-[#17241F] py-4 px-8 rounded-full text-center cursor-pointer hover:bg-[#17241F] hover:text-[#C9FF90] transition duration-300 border-2 border-inner border-[#C9FF90] '>Schedule A Meeting</button>
                        </div>
