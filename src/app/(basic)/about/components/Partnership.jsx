...
const Tag = ({ text }) => (
    <p className='outfit text-[#07302C] px-3 py-2 text-lg md:text-base bg-linear-to-r from-white to-[#C9FF90] w-fit rounded-full border border-[#D6E3C8]'>
        {text}
    </p>
);
    ...
    return (
        <section className='w-full bg-white'>
            <div className='max-w-[1380px] mx-auto py-20 px-4 flex flex-col items-center justify-center'>
                ...
                {/* cards section */}
                <div className='mt-20 flex flex-col md:flex-row w-full gap-6'>
                    <div className='flex flex-col gap-6'>
                        <div className='flex flex-col md:flex-row items-stretch gap-6'>
                            <div className='bg-[#F2F8ED] rounded-xl'>
                                <div className='px-7 py-8 mb-3'>
                                    <h1 className='text-[#212121] bricolage font-medium text-3xl mb-2.5'>What We Build for Brands</h1>
                                    <p className='outfit text-[#575656]'>Thoughtfully designed solutions that help brands grow, connect, and stand out.</p>
                                </div>
                                ...
                                <div className="relative">
                                    ...
                                    <div className="absolute bottom-5 left-5 flex gap-1.5">
                                        <p className="text-xl font-medium uppercase p-2.5 bg-white rounded-2xl text-[#212121]">
                                            Branding
                                        </p>
                            ...
                            <div className='bg-linear-to-b from-[#F5F5F5] to-[#EEFFDE] rounded-xl px-7 py-8 relative overflow-hidden'>
                                {/* Header Section */}
                                <div>
                                    <h1 className='text-[#212121] bricolage font-medium text-3xl mb-2.5'>Outcome-Driven Design</h1>
                                    <p className='outfit text-[#575656]'>
                                ...
                                <div className="relative top-4 flex flex-col gap-6 items-center">
                                    ...
                                    <svg className="absolute top-0 h-full w-full pointer-events-none opacity-50 md:opacity-100" viewBox="0 0 200 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className='w-full bg-linear-to-r from-[#BAC6AE] to-[#08312C] rounded-xl overflow-hidden relative z-0 '>
                            <div className='absolute inset-0 bg-linear-to-r from-[#C9FF8F] to-transparent -z-10'></div>

                            <div className='z-10 flex justify-between relative'>
                                <div className='px-8 py-16'>
                                    <h1 className="text-[20px] sm:text-[26px] md:text-[32px] font-medium text-[#212121] bricolage max-w-[200px] leading-[35px] tracking-tight mb-5">Design That Drives Impact</h1>
                                    <p className='outfit tracking-tight text-[#596948] max-w-[350px]'>We are a design agency focused on creating meaningful digital experiences.</p>
                                </div>

                                <div>
                                    <img className='max-h-[220px] absolute right-0 md:right-6 bottom-0' src="https://i.ibb.co.com/0yFPN8vw/image.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className='bg-[#F3F7EF] w-full md:max-w-1/3 h-[800px] md:h-auto rounded-xl relative overflow-hidden'>
                        ...
                        <div className='absolute bottom-0 left-0 right-0'>
                            <img className='max-h-[550px] w-full' src="https://i.ibb.co.com/xq1BnSsW/image.png" alt="" />
                        </div>
                    </div>
                </div>
            </div>
